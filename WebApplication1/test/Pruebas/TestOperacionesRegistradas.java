 ...
 * @author Cristian
 */
public class TestOperacionesRegistradas {
    
    public TestOperacionesRegistradas() {
    }
    ...
    public void testOperacionRegSec()    {
        ...
        assertFalse(OperacionEsperaSec.insertarOperacion(id, emailOferente, emailIntermediario, nitValor, nomValor, precioUnidad, cantidad, tipoDeValor, idSolicitud));
        assertFalse(OperacionEsperaPrim.insertarOperacion(id, emailOferente, emailIntermediario, nitValor, nomValor, precioUnidad, cantidad, idSolicitud));
        assertFalse(OperacionEsperaPrim.eliminarOperacion(id));
